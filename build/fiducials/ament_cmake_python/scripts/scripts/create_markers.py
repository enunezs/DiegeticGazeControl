...
def genMarker(i, dicno, paper_size):
    ...
    cairo = subprocess.Popen(
        ("cairosvg", "-f", "pdf", "-o", "/tmp/marker%d.pdf" % i, "/dev/stdin"),
...
if __name__ == "__main__":
    ...
    parser.add_argument("startId", type=int, help="start of marker range to generate")
    parser.add_argument("endId", type=int, help="end of marker range to generate")
    parser.add_argument("pdfFile", type=str, help="file to store markers in")
    parser.add_argument(
        "dictionary",
        type=int,
        default="7",
    ...
    parser.add_argument(
        ...
        action="store",
        default="letter",
        help="paper size to use (letter or a4)",
    )
    ...
    print(
        "\033[91m"
        + """After printing, please make sure that the long lines around the marker are
EXACTLY 14.0 cm long. This is required for accurate position estimation."""
        + "\033[0m"
    )
