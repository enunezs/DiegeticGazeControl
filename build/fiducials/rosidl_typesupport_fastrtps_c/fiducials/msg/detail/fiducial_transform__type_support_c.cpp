...
#include "fiducials/msg/detail/fiducial_transform__rosidl_typesupport_fastrtps_c.h"
...
using _FiducialTransform__ros_msg_type = fiducials__msg__FiducialTransform;
...
static uint32_t _FiducialTransform__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_fiducials__msg__FiducialTransform(
...
static size_t _FiducialTransform__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_fiducials__msg__FiducialTransform(
