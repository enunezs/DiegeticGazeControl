...
#include "fiducials/msg/detail/fiducial_transform_array__rosidl_typesupport_fastrtps_c.h"
...
#include "fiducials/msg/detail/fiducial_transform__functions.h"  // transforms
#include "std_msgs/msg/detail/header__functions.h"  // header

// forward declare type support functions
size_t get_serialized_size_fiducials__msg__FiducialTransform(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_fiducials__msg__FiducialTransform(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, fiducials, msg, FiducialTransform)();
...
using _FiducialTransformArray__ros_msg_type = fiducials__msg__FiducialTransformArray;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: transforms
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, fiducials, msg, FiducialTransform
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: transforms
  {
    ...
    if (ros_message->transforms.data) {
      fiducials__msg__FiducialTransform__Sequence__fini(&ros_message->transforms);
    }
...
size_t get_serialized_size_fiducials__msg__FiducialTransformArray(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _FiducialTransformArray__ros_msg_type * ros_message = static_cast<const _FiducialTransformArray__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name transforms
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_fiducials__msg__FiducialTransform(
...
static uint32_t _FiducialTransformArray__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_fiducials__msg__FiducialTransformArray(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_fiducials
size_t max_serialized_size_fiducials__msg__FiducialTransformArray(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: transforms
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      current_alignment +=
        max_serialized_size_fiducials__msg__FiducialTransform(
        inner_full_bounded, inner_is_plain, current_alignment);
      full_bounded &= inner_full_bounded;
      is_plain &= inner_is_plain;
    }
...
static size_t _FiducialTransformArray__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_fiducials__msg__FiducialTransformArray(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, fiducials, msg, FiducialTransformArray)() {
