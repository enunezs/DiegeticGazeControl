...
#include "fiducials/msg/detail/fiducial_transform__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const fiducials::msg::FiducialTransform & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  fiducials::msg::FiducialTransform & ros_message)
{
  // Member: fiducial_id
  cdr >> ros_message.fiducial_id;
...
{
  auto typed_message =
    static_cast<const fiducials::msg::FiducialTransform *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<fiducials::msg::FiducialTransform *>(
    untyped_ros_message);
...
static size_t _FiducialTransform__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_FiducialTransform(full_bounded, is_plain, 0);
...
{
  return &fiducials::msg::typesupport_fastrtps_cpp::_FiducialTransform__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, fiducials, msg, FiducialTransform)() {
  return &fiducials::msg::typesupport_fastrtps_cpp::_FiducialTransform__handle;
}
