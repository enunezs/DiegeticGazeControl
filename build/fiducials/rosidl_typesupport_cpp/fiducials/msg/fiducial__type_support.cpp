...
static const _Fiducial_type_support_symbol_names_t _Fiducial_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, fiducials, msg, Fiducial)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, fiducials, msg, Fiducial)),
  }
};
...
{
  return &::fiducials::msg::rosidl_typesupport_cpp::Fiducial_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, fiducials, msg, Fiducial)() {
  return get_message_type_support_handle<fiducials::msg::Fiducial>();
}
