...
static const _FiducialTransform_type_support_symbol_names_t _FiducialTransform_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, fiducials, msg, FiducialTransform)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, fiducials, msg, FiducialTransform)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, fiducials, msg, FiducialTransform)() {
  return &::fiducials::msg::rosidl_typesupport_c::FiducialTransform_message_type_support_handle;
}
