...
#include "diegetic_button_pkg/msg/detail/diegetic_button__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/detail/transform__functions.h"  // button_transform
...
using _DiegeticButton__ros_msg_type = diegetic_button_pkg__msg__DiegeticButton;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _DiegeticButton__ros_msg_type * ros_message = static_cast<const _DiegeticButton__ros_msg_type *>(untyped_ros_message);
  ...
  // Field name: button_transform
  {
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->button_transform, cdr))
    {
      return false;
    }
  }
  ...
  void * untyped_ros_message)
{
  ...
  _DiegeticButton__ros_msg_type * ros_message = static_cast<_DiegeticButton__ros_msg_type *>(untyped_ros_message);
  // Field name: button_id
  {
    std::string tmp;
    cdr >> tmp;
...
static uint32_t _DiegeticButton__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_diegetic_button_pkg__msg__DiegeticButton(
...
static size_t _DiegeticButton__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_diegetic_button_pkg__msg__DiegeticButton(
...
static message_type_support_callbacks_t __callbacks_DiegeticButton = {
...
static rosidl_message_type_support_t _DiegeticButton__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_DiegeticButton,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, diegetic_button_pkg, msg, DiegeticButton)() {
  return &_DiegeticButton__type_support;
}
