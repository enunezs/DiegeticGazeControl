...
#include "diegetic_button_pkg/msg/detail/diegetic_button_array__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const diegetic_button_pkg::msg::DiegeticButton &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  ...
  size_t current_alignment)
{
  ...
  // Member: buttons
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      current_alignment +=
        diegetic_button_pkg::msg::typesupport_fastrtps_cpp::max_serialized_size_DiegeticButton(
        inner_full_bounded, inner_is_plain, current_alignment);
      full_bounded &= inner_full_bounded;
      is_plain &= inner_is_plain;
    }
...
{
  auto typed_message =
    static_cast<const diegetic_button_pkg::msg::DiegeticButtonArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<diegetic_button_pkg::msg::DiegeticButtonArray *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _DiegeticButtonArray__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const diegetic_button_pkg::msg::DiegeticButtonArray *>(
...
static size_t _DiegeticButtonArray__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_DiegeticButtonArray(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _DiegeticButtonArray__callbacks = {
...
static rosidl_message_type_support_t _DiegeticButtonArray__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_DiegeticButtonArray__callbacks,
...
{
  return &diegetic_button_pkg::msg::typesupport_fastrtps_cpp::_DiegeticButtonArray__handle;
}
