...
static const _InputStatusArray_type_support_symbol_names_t _InputStatusArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, diegetic_button_pkg, msg, InputStatusArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, diegetic_button_pkg, msg, InputStatusArray)),
  }
};
...
{
  return &::diegetic_button_pkg::msg::rosidl_typesupport_cpp::InputStatusArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, diegetic_button_pkg, msg, InputStatusArray)() {
  return get_message_type_support_handle<diegetic_button_pkg::msg::InputStatusArray>();
}
