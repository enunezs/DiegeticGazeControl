...
static const _InputStatus_type_support_symbol_names_t _InputStatus_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, diegetic_button_pkg, msg, InputStatus)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, diegetic_button_pkg, msg, InputStatus)),
  }
};
...
{
  return &::diegetic_button_pkg::msg::rosidl_typesupport_cpp::InputStatus_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, diegetic_button_pkg, msg, InputStatus)() {
  return get_message_type_support_handle<diegetic_button_pkg::msg::InputStatus>();
}
