...
: ${AMENT_CURRENT_PREFIX:="/root/ws/origami/install/origami"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/origami/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/origami/environment/path.sh"
