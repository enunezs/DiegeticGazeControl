...
class arucoPublisher(Node):
    def __init__(self):
        ...
        # Aruco parameters
        aruco_dict = aruco.DICT_5X5_1000  # TODO: Restrict dictionary number later
    ...
    def detect_aruco_markers(self, img_msg):
        ...
        # print("Fiducial array message published")
        ...
        # print( f"Aruco processing time is {(end_time - start_time).nanoseconds*0.000000001}")
    ...
    def pack_fiducial_array_msg(self, corners, ids):
        ...
        if ids is not None:
            ...
            # print("%i markers found, sending message" % len(ids))
        else:
            pass
            # print("No markers found, sending empty message")
    ...
    def pack_fiducial_transform_array_msg(self, ids, rvecs, tvecs):
        ...
        if rvecs is not None:
            for i in range(len(rvecs)):
                ...
                # print("Fiducial transform message sent")
                """
